        ...
        <Row lg={2} xs={1}>
          <Col>
            <div className="option-container">
              ...
              <div className="blurb">
                <p>Rooms are available at a reduced rate of $149 / night (plus tax).</p>
                <p>
                  Call <a href="tel:800-445-8667">800-445-8667</a> to book. The block is reserved
                  under Dornblaser/Sibner Wedding.
                </p>
              </div>
            </div>
          </Col>
